  ...
  <div class="col-sm-12 view-list-tbl">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <table id="tag-tbl" class="table table-striped table-bordered" cellspacing="0" width="100%">
          <thead>
            <tr>
              <th>No</th>
              <th>Tag</th>
...
<script type="text/javascript">
  jQuery(document).ready(function($)
  {
    ...
    $("div.btn-wrap" ).append('<a class="btn btn-blue pull-right" href="{!! $addurl !!}" ><i class="fa fa-plus visible-xs"></i> <span class="hidden-xs">New Tag</span></a>');
  });
  $.ajaxSetup({
    headers: {
